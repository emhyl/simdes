...
class Dataskck extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/view_skck',$data);
		$this->load->view('admin/view_footer');

	}
	public function tambah(){
		$this->load->view('admin/view_header');
		$this->load->view('admin/view_tambah_skck');
		$this->load->view('admin/view_footer');
	}
	...
	public function edit($id_skck){
		...
		$this->load->view('admin/view_edit_skck',$data);
		$this->load->view('admin/view_footer');
	}
	...
	public function detail_skck()
	{
		$this->load->view('admin/view_header');
		$data['tb_skck']	= $this->M_datamaster->tampil_data('tb_skck');
		$this->load->view('admin/view_detail_skck',$data);
		$this->load->view('admin/view_footer');

	}
	public function tambah_detail_skck(){
		$this->load->view('admin/view_header');
		$this->load->view('admin/view_tambah_detail_skck');
		$this->load->view('admin/view_footer');
	}
	public function aksi_tambah_detail_skck(){
		...
		$this->M_datamaster->input_data($data,'tb_skck');
		redirect('admin/Dataskck/detail_skck');
	}
	public function edit_detail_skck($id_skck){
		...
		$this->load->view('admin/view_header');
		$data['tb_skck'] = $this->M_datamaster->edit_data($where,'tb_skck')->result();
		$this->load->view('admin/view_edit_detail_skck',$data);
		$this->load->view('admin/view_footer');
	}
	...
	public function report($id = ''){
		$data['data'] = $this->M_datamaster->edit_data(['id_skck' => $id],'tb_skck')->result();
		...
		$this->pdf->load('admin/report_PDF/skck',$data,$paper);
	}
