...
class Datadomisili extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('masyarakat/view_domisili',$data);
		$this->load->view('masyarakat/view_footer');

	}
	public function tambah(){
		$this->load->view('masyarakat/view_header');
		$this->load->view('masyarakat/view_tambah_domisili');
		$this->load->view('masyarakat/view_footer');
	}
	public function aksi_tambah(){
		...
		redirect('masyarakat/Datadomisili/');
	}
	public function edit($id_domisili){
		...
		$this->load->view('masyarakat/view_edit_domisili',$data);
		$this->load->view('masyarakat/view_footer');
	}
	...
	public function detail_domisili()
	{
		$this->load->view('masyarakat/view_header');
		$data['tb_domisili']	= $this->M_datamaster->tampil_data('tb_domisili');
		$this->load->view('masyarakat/view_detail_domisili',$data);
		$this->load->view('masyarakat/view_footer');

	}
	public function tambah_detail_domisili(){
		$this->load->view('masyarakat/view_header');
		$this->load->view('masyarakat/view_tambah_detail_domisili');
		$this->load->view('masyarakat/view_footer');
	}
	public function aksi_tambah_detail_domisili(){
		...
		$this->M_datamaster->input_data($data,'tb_domisili');
		redirect('masyarakat/Datadomisili/detail_domisili');
	}
	public function edit_detail_domisili($id_domisili){
		...
		$this->load->view('masyarakat/view_header');
		$data['tb_domisili'] = $this->M_datamaster->edit_data($where,'tb_domisili')->result();
		$this->load->view('masyarakat/view_edit_detail_domisili',$data);
		$this->load->view('masyarakat/view_footer');
	}
