...
class Datasertifikat extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('masyarakat/view_sertifikat',$data);
		$this->load->view('masyarakat/view_footer');

	}
	public function tambah(){
		$this->load->view('masyarakat/view_header');
		$this->load->view('masyarakat/view_tambah_sertifikat');
		$this->load->view('masyarakat/view_footer');
	}
	public function aksi_tambah(){
		...
		redirect('masyarakat/Datasertifikat/');
	}
	public function edit($id_sertifikat){
		...
		$this->load->view('masyarakat/view_edit_sertifikat',$data);
		$this->load->view('masyarakat/view_footer');
	}
	...
	public function detail_sertifikat()
	{
		$this->load->view('masyarakat/view_header');
		$data['tb_sertifikat']	= $this->M_datamaster->tampil_data('tb_sertifikat');
		$this->load->view('masyarakat/view_detail_sertifikat',$data);
		$this->load->view('masyarakat/view_footer');

	}
	public function tambah_detail_sertifikat(){
		$this->load->view('masyarakat/view_header');
		$this->load->view('masyarakat/view_tambah_detail_sertifikat');
		$this->load->view('masyarakat/view_footer');
	}
	public function aksi_tambah_detail_sertifikat(){
		...
		$this->M_datamaster->input_data($data,'tb_sertifikat');
		redirect('masyarakat/Datasertifikat/detail_sertifikat');
	}
	public function edit_detail_sertifikat($id_sertifikat){
		...
		$this->load->view('masyarakat/view_header');
		$data['tb_sertifikat'] = $this->M_datamaster->edit_data($where,'tb_sertifikat')->result();
		$this->load->view('masyarakat/view_edit_detail_sertifikat',$data);
		$this->load->view('masyarakat/view_footer');
	}
