...
class Datakk extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('masyarakat/view_kk',$data);
		$this->load->view('masyarakat/view_footer');

	}
	public function tambah(){
		$this->load->view('masyarakat/view_header');
		$this->load->view('masyarakat/view_tambah_kk');
		$this->load->view('masyarakat/view_footer');
	}
	...
	public function edit($id_kk){
		...
		$this->load->view('masyarakat/view_edit_kk',$data);
		$this->load->view('masyarakat/view_footer');
	}
	...
	public function detail()
	{
		$this->load->view('masyarakat/view_header');
		$data['tb_kk']	= $this->M_datamaster->tampil_data('tb_kk');
		$this->load->view('masyarakat/view_detail',$data);
		$this->load->view('masyarakat/view_footer');

	}
	public function tambah_detail(){
		$this->load->view('masyarakat/view_header');
		$this->load->view('masyarakat/view_tambah_detail');
		$this->load->view('masyarakat/view_footer');
	}
	public function aksi_tambah_detail(){
		...
		$this->M_datamaster->input_data($data,'tb_kk');
		redirect('masyarakat/Datakk/detail');
	}
	public function edit_detail($id_kk){
		...
		$this->load->view('masyarakat/view_header');
		$data['tb_kk'] = $this->M_datamaster->edit_data($where,'tb_kk')->result();
		$this->load->view('masyarakat/view_edit_detail',$data);
		$this->load->view('masyarakat/view_footer');
	}
