            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo base_url()."admin/Datamaster"?>"><i class="fa fa-user"></i> Data penduduk </a>
                    ...
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url()."admin/Datakk"?>">Data KK</a></li>
                      <li><a href="<?php echo base_url()."admin/Dataakta"?>">Data Akta</a></li>
                      <li><a href="<?php echo base_url()."admin/Datadomisili"?>">Data Domisili</a></li>
                     <!--  <li><a href="<?php echo base_url()."admin/Datasertifikat"?>">Data Sertifikat</a></li> -->
                      <li><a href="<?php echo base_url()."admin/Dataskck"?>">Data Skck</a></li>
                     
                     
                      
                    </ul>
                    <li><a href="https://www.gmail.com/" target="_blank"><i class="fa fa-desktop"></i>SendFiel </a>
