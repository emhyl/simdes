          ...
          <div class="x_content">
            ...
            <form action="<?php echo base_url('admin/Admin/update') ?>" method="post" enctype="multipart/form-data" role="form" data-parsley-validate="" class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" value="<?php echo $l->adm_foto?>" name="filefoto"  class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="select2_single form-control" name="adm_level">
                    ...
                    <option value="Masyarakat" <?php $l->adm_level == 'Masyrakat' ? print "selected" : "" ?>>Masyarakat</option>
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                 <a type="button" class="btn btn-danger" href="<?php echo base_url()."admin/Admin/"?>" style="color: #fff">Kembali</i></a>
