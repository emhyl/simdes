    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          ?>
            <form action="<?php echo base_url('masyarakat/datadomisili/update') ?>" method="post" enctype="multipart/form-data" role="form" data-parsley-validate="" class="form-horizontal form-label-left">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                 <label class="col-md-3 col-sm-3 col-xs-12" for="last-name">Keterangan<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  ...
                  <a type="button" class="btn btn-danger" href="<?php echo base_url()."masyarakat/datadomisili/"?>" style="color: #fff">Kembali</i></a>
